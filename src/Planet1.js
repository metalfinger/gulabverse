...
{
    float rad = 0.343;
    float radW = 0.01 + 0.03*outerGlowIntensity; //bluriness at border
...
{
    float rad = 0.32;
    float radW = 0.049; //bluriness at border
...
void main()
{
    ...
    vec3 innerGlowVar = vec3(181.0/255.0, 112.0/255.0, 35.0/255.0) * innerGlow * 1.0; 
...
function Planet1() {
  ...
  function focusOnThis() {
    ...
    document.querySelector(".planet1").classList.add("selectedplanet");
  }
  ...
  function focusOffThis() {
    ...
    document.querySelector(".planet1").classList.remove("selectedplanet");
  }
  ...
  return (
    <div className="planet planet1" onClick={handleClick}>
      <ShaderCanvas
