...
function Planet5() {
  ...
  function focusOnThis() {
    ...
    document.querySelector(".planet5").classList.add("selectedplanet");
  }
  ...
  function focusOffThis() {
    ...
    document.querySelector(".planet5").classList.remove("selectedplanet");
  }
  ...
  return (
    <div className="planet planet5" onClick={handleClick}>
      <ShaderCanvas
