...
function Planet6() {
  ...
  function focusOnThis() {
    ...
    document.querySelector(".planet6").classList.add("selectedplanet");
  }
  ...
  function focusOffThis() {
    ...
    document.querySelector(".planet6").classList.remove("selectedplanet");
  }
  ...
  return (
    <div className="planet planet6" onClick={handleClick}>
      <ShaderCanvas
